        ...
        <header className="header">
            <div className="container">
                <nav className="header__nav">
                    ...
                    {
                        user.email === "magezamuslim4000@gmail.com" ? <Link to={'/admin-panel'}>
                            Aдмин панель
                        </Link> : ""
                    }

                    <Link to={`${user  ? "/profile" : "/register"}`} className="header__user">
                        <div className="header__user-circle">
                            <img className="header__avatar" src={localStorage.getItem("user") ? user?.avatar : avatar} alt=""/>
                        </div>
                        { localStorage.getItem("user") ? user?.login : "User"}
                    </Link>
                    ...
                    <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <input
                            ...
                            value={search}
                        />
                        <div className={`header__search-result ${search ? 'active' : ''}`}
                    ...
                    <div className="header__right">
                        ...
                        <Link to={'/cart'} className="header__right-link">
